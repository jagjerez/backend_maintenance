...
export class IntegrationJobsController {
  ...
  async create(
    @Body() createIntegrationJobDto: CreateIntegrationJobDto,
  ...
  @ApiResponse({
    status: 200,
    description: 'Integration jobs retrieved successfully',
  })
  @ApiQuery({
    name: 'page',
    required: false,
  ...
  @ApiResponse({
    status: 200,
    description: 'Deleted integration jobs retrieved successfully',
  })
  @ApiQuery({
    name: 'companyId',
    required: true,
  ...
  @ApiResponse({
    status: 200,
    description: 'Integration job retrieved successfully',
    type: IntegrationJob,
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'Integration job updated successfully',
    type: IntegrationJob,
  })
  @ApiResponse({ status: 404, description: 'Integration job not found' })
  @ApiQuery({
  ...
  async update(
    ...
    return this.integrationJobsService.update(
      id,
  ...
  @ApiResponse({
    status: 204,
    description: 'Integration job deleted successfully',
  })
  @ApiResponse({ status: 404, description: 'Integration job not found' })
  @ApiQuery({
    name: 'companyId',
  ...
  @ApiResponse({
    status: 200,
    description: 'Integration job restored successfully',
    type: IntegrationJob,
  })
  @ApiResponse({
    status: 404,
    description: 'Integration job not found or not deleted',
  })
  @ApiQuery({
    name: 'companyId',
    required: true,
