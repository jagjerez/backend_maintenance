...
export class UsersController {
  ...
  @ApiQuery({ name: 'role', required: false, enum: ['admin', 'user', 'manager'], description: 'Filter by role' })
  @ApiQuery({ name: 'isActive', required: false, type: Boolean, description: 'Filter by active status' })
  @ApiQuery({ name: 'emailVerified', required: false, type: Boolean, description: 'Filter by email verified status' })
